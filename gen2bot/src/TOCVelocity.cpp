...
void TOCVelocity::displayData(TalonFX* talon1, string name)
{
...
void TOCVelocity::displayData(TalonSRX* talon1, TalonSRX* talon2, string name)
{
...
bool TOCVelocity::ReverseLimitSwitchTriggered(TalonFX* talon1, string name)
{
...
bool TOCVelocity::ReverseLimitSwitchTriggered(TalonSRX* talon1, TalonSRX* talon2, string name)
{
...
bool TOCVelocity::TargetPositionReached(TalonFX* talon1, int pos, string name)
{
...
bool TOCVelocity::TargetPositionReached(TalonSRX* talon1, TalonSRX* talon2, int pos, string name)
{
...
void TOCVelocity::zero(int& p_cmd, ros::NodeHandle  nh) 
{
	...
	std::cout << "Zeroing the bScrew" << st	d::endl;
	...
	if(CheckMode(laDrivePosition, buDrivePosition, bsDrivePosition))
		{
			...
			while(!CheckMode(laDigPosition, buDigPosition, bsDigPosition))
			{
				...
				if (TargePositionReached(&linAct1, &linAct2, laDigPostion, "linAct"))
				{
					ctre::phoenix::unmanaged::Unmanaged::FeedEnable(100000);
